test_that("isManderGrid correctly identifies Mander grids", {
  ...
  bad1 <- tibble::tibble(p1=NA, nStage1=NA, nTotal=NA, rFutility=NA, rSuccess=NA, rTotal=NA, Type1=NA, Type2=NA, PETNull=NA, PETAlt=NA, AveSizeNull=NA,
                         AveSizeAlt=NA)
  bad2 <- tibble::tibble(p0=NA, nStage1=NA, nTotal=NA, rFutility=NA, rSuccess=NA, rTotal=NA, Type1=NA, Type2=NA, PETNull=NA, PETAlt=NA, AveSizeNull=NA,
                         AveSizeAlt=NA)
  bad3 <- tibble::tibble(p0=NA, p1=NA, nTotal=NA, rFutility=NA, rSuccess=NA, rTotal=NA, Type1=NA, Type2=NA, PETNull=NA, PETAlt=NA, AveSizeNull=NA,
                         AveSizeAlt=NA)
  bad4 <- tibble::tibble(p0=NA, p1=NA, nStage1=NA, rFutility=NA, rSuccess=NA, rTotal=NA, Type1=NA, Type2=NA, PETNull=NA, PETAlt=NA, AveSizeNull=NA,
                         AveSizeAlt=NA)
  bad5 <- tibble::tibble(p0=NA, p1=NA, nStage1=NA, nTotal=NA, rSuccess=NA, rTotal=NA, Type1=NA, Type2=NA, PETNull=NA, PETAlt=NA, AveSizeNull=NA,
                         AveSizeAlt=NA)
